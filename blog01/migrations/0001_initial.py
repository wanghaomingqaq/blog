    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='editor/default.png', upload_to='editor')),
            ],
        ),
        migrations.CreateModel(
            name='Article',
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog01.category', verbose_name='分类')),
                ('tags', models.ManyToManyField(blank=True, to='blog01.Tag', verbose_name='标签集合')),
            ],
            options={
                'verbose_name': '文章',
